...
{
    internal static EqualityComparer<T> ValueComparer = EqualityComparer<T>.Default;
    ...
    public bool Equals(KDEntry<T> other)
    {
        ...
        return ValueComparer.Equals(other._value, _value);
    }
