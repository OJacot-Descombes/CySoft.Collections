...
{
    readonly KDNode<T> _treeRoot;
    readonly int _maxPointsReturned;
    private readonly double[] _searchPoint = null;
    private readonly DistanceFunction _distanceStrategy;
    ...
    {
        private readonly NearestNeighborEnumerable<T> _enumerable;
        ...
        public void Reset()
        {
            _pointsRemaining = Math.Min(_enumerable._maxPointsReturned, _enumerable._treeRoot._count);
